        ...
        <div className="h-screen flex flex-col justify-center items-center p-4 font-mono">
            ...
            <div className="text-center max-w-screen-lg">
                ...
                <p className="text-sm md:text-2xl my-8">
                    My name is <span className="font-bold">Sebastian Aldi</span>, and I am a senior software engineer with {calculateWorkExperience(Data.workExperience)} years of professional experience.
                </p>
